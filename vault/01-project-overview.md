...
| :--- | :--- | :--- |
| **Sandboxed Shallow Cloning** | `GitCloner` via native `git` CLI (`depth=1`, `subprocess.run(shell=False)`), branch-aware, scrubbed env, workspace isolation. | [git_cloner.py](file:///c:/Users/nikhil/Desktop/projectss/github-repo-intelligence-platform/codesensei-github-repo-intelligence-platform/analysis-engine/engine/cloning/git_cloner.py) |

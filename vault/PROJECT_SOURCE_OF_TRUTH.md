...
| **Command Injection** | Branch names validated via regex; `GitPython` passes arguments as discrete arrays, bypassing shell invocation. | [security.py](file:///c:/Users/nikhil/Desktop/projectss/github-repo-intelligence-platform/codesensei-github-repo-intelligence-platform/backend/app/core/security.py#L23) | None; shell execution disabled. |

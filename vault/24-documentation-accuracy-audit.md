...
| **Prometheus Exposition** | Metrics exposed via `/metrics` (requests, duration, jobs, build info) and `:9100` on worker. | [middleware.py](file:///c:/Users/nikhil/Desktop/projectss/github-repo-intelligence-platform/codesensei-github-repo-intelligence-platform/backend/app/core/middleware.py#L15-L80): Prometheus counters, histograms, and gauges. | **VERIFIED (100%)** |
